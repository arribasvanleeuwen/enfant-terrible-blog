...
<style>
/* Minima Override for this page only */
.main-content { max-width: 100% !important; padding: 0 !important; background: #0e0e0e; }
.site-main { background: #0e0e0e; }
...
.stat-item .label {
  color: #e62117; /* Enfant Terrible Brand Red */
